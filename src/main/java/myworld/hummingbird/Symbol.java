...
public record Symbol(String name, Type type, int offset, TypeFlag rType, Params parameters, int registers) {
    ...
    public static Symbol empty(String name){
        return new Symbol(name, null, EMPTY_OFFSET, null, Params.zeroes(), 0);
    }

    public static Symbol data(String name, int offset){
        return new Symbol(name, Type.DATA, offset, null, null, 0);
    }

    public static Symbol function(String name, int offset, TypeFlag rType, Params parameters, int registers){
